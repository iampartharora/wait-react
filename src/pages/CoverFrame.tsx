  ...
  return (
    <LocalizationProvider dateAdapter={AdapterDateFns}>
      <div className={styles.coverFrame}>
        ...
        <img className={styles.coverFrameItem} alt="" src="/group-16.svg" />
                ...
                <div className={styles.hotelCard1}>
                  <a className={styles.hotelCard} href="#">
                    ...
                    <div className={styles.stayDetails}>
                      ...
                      <img className={styles.videoIcon} alt="" />
                    </div>
          ...
          <div className={styles.footerSection}>
            ...
            <footer className={styles.footer}>
              <div className={styles.fickleflightBio}>
                <img className={styles.fickleflightLogoIcon} alt="" />
                <div className={styles.fickleFlightIs}>
                  Fickle Flight is your one-stop travel portal. We offer hassle
                  free flight and hotel bookings. We also have all your flight
                  needs in you online shop.
                </div>
                <img className={styles.socialIcons} alt="" />
              </div>
